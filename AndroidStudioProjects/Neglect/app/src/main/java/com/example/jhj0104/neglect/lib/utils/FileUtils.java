...
import static com.example.jhj0104.neglect.common.Loop.TestName;

public class FileUtils {
    private static final String TAG = FileUtils.class.getSimpleName();
    public static String DIR_NAME = "UsbWebCamera";
    volatile static boolean saveFlag = false;
...
//			result = SDUtils.createStorageFile(context, save_tree_id, "*/*", file_name);
        ...
        if (result == null) {
            ...
            // If not declare WRITE_EXTERNAL_STORAGE cant save video file...:(
        ...
        if (result != null) {
            if(!saveFlag){
                result = new File(result, fileName+"_"+TestName+"_practice.mp4");
                saveFlag=true;
            }
            else{
                result = new File(result, fileName+"_"+TestName+"_test.mp4");
                saveFlag=false;
            }
